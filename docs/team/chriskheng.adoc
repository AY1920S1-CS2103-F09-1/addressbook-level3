...
In many co-curricular activities (CCAs), interviews are usually conducted to recruit new members or committees during the beginning of
...
We therefore came up with Scheduler, a desktop application which aims to automate and streamline this laborious process of
scheduling interviews and to minimise human errors in the scheduling process.

Its main feature is to match interviewees with interview time slots to generate an optimal interview timetable, and works with
