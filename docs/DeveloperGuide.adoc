...
**Edge** +
An edge represents a possible matching relationship  between interviewer and interview slot. An edge exists between interviewee and interview slot if any only if the interviewee can attend the slot.

**Matching Criteria** +
An interviewee can attend an interview slot (i.e. matches the interview slot) if **all** the criteria below are fulfilled:
...
The **activity diagram** below to summarise the key steps in the algorithm.

image::HopCroftKarp.png[]
